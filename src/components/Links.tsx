...
const Links = () => {
  return (
    <div className='px-8 py-10 relative grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-8'>
        <div className='absolute w-full h-[1px] bg-gray-200 top-0 left-0'></div>
      <div className="mb-4">
        <h3 className="font-medium text-xl mb-2">About</h3>
      ...
      <div className="mb-4">
  <h3 className="font-medium text-xl mb-2">Artists</h3>
  <ul className='flex flex-col gap-3 text-[15px]'>
    ...
    <li><a href="#">Oliver Davis</a></li>
      ...
      <div className="mb-4">
        <h3 className="font-medium text-xl mb-2">Collect</h3>
        <ul className='flex flex-col gap-3 text-[15px]'>
      ...
      <div className="mb-4">
        <h3 className="font-medium text-xl mb-2">Exhibitions</h3>
        <ul className='flex flex-col gap-3 text-[15px]'>
      ...
      <div className="mb-4">
        <h3 className="font-medium text-xl mb-2">News</h3>
        <ul className='flex flex-col gap-3 text-[15px]'>
      ...
      <div className="mb-4">
        <h3 className="font-medium text-xl mb-2">Shop</h3>
        <ul className='flex flex-col gap-3 text-[15px]'>
